...
Read through the setup instructions from the Django [Models](https://git.generalassemb.ly/dc-wdi-python-django/django-models) and [Views and Templates](https://git.generalassemb.ly/dc-wdi-python-django/django-views-and-templates)
...
## Instructions
  ...
  1. Set up your virtual environment and activate it. https://docs.python-guide.org/dev/virtualenvs/
  1. Install django in that activated environment.
