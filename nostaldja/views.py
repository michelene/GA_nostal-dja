...
def decade_list(request):
    # get all the decades from the database
    decades = Decade.objects.all()
    # send the HTML template back to the client
